...
import AboutMeDetailedToolCategoryCompact from "../about-me-detailed-tool-category-compact/AboutMeDetailedToolCategoryCompact";
   ...
   return (
      <div className="about-me-detailed__tools about-me-detailed__tools--compact lg:hidden flex flex-col py-25 bg-card">
         <motion.div initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="about-me-detailed__tools-header flex flex-col min-w-screen">
            <h3 className="about-me-detailed__tools-title font-hanken-grotesk text-center text-[clamp(var(--font-size-display-sm),12vw,var(--font-size-display-xl))] mb-12.5 text-heading font-bold leading-none">{ABOUT_ME_DETAILED_TOOLS_TITLE}</h3>
            <div className="about-me-detailed__tools-icon-container flex flex-col h-full items-center justify-center">
               ...
               <span className="about-me-detailed__tools-description font-hanken-grotesk font-semibold text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] text-accent mt-4">{ABOUT_ME_DETAILED_TOOLS_DESCRIPTION}</span>
            </div>
         </motion.div>
