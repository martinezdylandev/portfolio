...
import AboutMeDetailedToolCategoryDesktop from "../about-me-detailed-tool-category-desktop/AboutMeDetailedToolCategoryDesktop";
   ...
   return (
      <div className="about-me-detailed__tools about-me-detailed__tools--desktop hidden lg:flex flex-col py-25 bg-card">
         <motion.div initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="about-me-detailed__tools-header flex flex-col gap-12.5 min-w-screen min-h-screen">
            <h3 className="about-me-detailed__tools-title font-hanken-grotesk text-[clamp(var(--font-size-display-md),12vw,var(--font-size-display-2xl))] text-heading font-bold leading-none">{ABOUT_ME_DETAILED_TOOLS_TITLE}</h3>
