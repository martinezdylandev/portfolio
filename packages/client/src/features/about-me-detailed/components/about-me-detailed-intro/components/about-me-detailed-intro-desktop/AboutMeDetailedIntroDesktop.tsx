...
const AboutMeDetailedIntroDesktop = (): React.ReactElement => {
   ...
   return (
      <div className="about-me-detailed__intro--desktop hidden lg:block relative py-25 min-w-screen min-h-screen bg-page">
         <motion.h3 initial={titleInitial} whileInView={titleWhileInView} transition={titleTransition} viewport={titleViewport} className="about-me-detailed__intro-title font-hanken-grotesk text-[clamp(var(--font-size-display-md),12vw,var(--font-size-display-2xl))] mb-12.5 text-heading font-bold leading-none">
            {ABOUT_ME_DETAILED_INTRO_TITLE}
         </motion.h3>
         <div className="about-me-detailed__intro-texts grid grid-cols-4 grid-rows-2 mx-12.5">
            <motion.span initial={textAnimations0.initial} whileInView={textAnimations0.whileInView} transition={textAnimations0.transition} viewport={textAnimations0.viewport} className="about-me-detailed__intro-text font-hanken-grotesk font-medium text-justify text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] col-start-1 text-heading">
               {ABOUT_ME_DETAILED_INTRO_TEXTS[0]}
            </motion.span>
            <motion.span initial={textAnimations1.initial} whileInView={textAnimations1.whileInView} transition={textAnimations1.transition} viewport={textAnimations1.viewport} className="about-me-detailed__intro-text font-hanken-grotesk font-medium text-justify text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] row-start-2 col-start-2 text-heading">
               {ABOUT_ME_DETAILED_INTRO_TEXTS[1]}
            </motion.span>
            <motion.span initial={textAnimations2.initial} whileInView={textAnimations2.whileInView} transition={textAnimations2.transition} viewport={textAnimations2.viewport} className="about-me-detailed__intro-text font-hanken-grotesk font-medium text-justify text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] col-start-3 text-heading">
               {ABOUT_ME_DETAILED_INTRO_TEXTS[2]}
            </motion.span>
            <motion.span initial={textAnimations3.initial} whileInView={textAnimations3.whileInView} transition={textAnimations3.transition} viewport={textAnimations3.viewport} className="about-me-detailed__intro-text font-hanken-grotesk font-medium text-justify text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] row-start-2 col-start-4 text-heading">
