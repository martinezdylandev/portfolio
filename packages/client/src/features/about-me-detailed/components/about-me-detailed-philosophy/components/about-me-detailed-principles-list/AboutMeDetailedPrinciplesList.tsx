...
const AboutMeDetailedPrinciplesList = (): React.ReactElement => {
   return (
      <div className="about-me-detailed__philosophy-principles-list flex flex-col justify-center px-25">
         ...
         <ul className="about-me-detailed__philosophy-principles-list-items text-body-lg text-left font-hanken-grotesk grid grid-cols-4 grid-rows-4 w-fit border-t-[5px] border-b-[5px] text-heading border-heading">
