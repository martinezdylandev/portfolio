   ...
   return (
      <motion.div className="about-me-detailed__philosophy about-me-detailed__philosophy--compact lg:hidden flex flex-col text-right py-25 bg-section">
         <motion.div initial={headerInitial} whileInView={headerWhileInView} transition={headerTransition} viewport={headerViewport} className="about-me-detailed__philosophy-header flex flex-col min-w-screen">
            <h3 className="about-me-detailed__philosophy-title font-hanken-grotesk text-center text-[clamp(var(--font-size-display-sm),12vw,var(--font-size-display-xl))] mb-12.5 text-heading font-bold leading-none">{ABOUT_ME_DETAILED_PHILOSOPHY_TITLE}</h3>
            <div className="about-me-detailed__philosophy-icon-container flex flex-col h-full self-center items-center justify-center">
               ...
               <span className="about-me-detailed__philosophy-description font-hanken-grotesk font-semibold text-[clamp(var(--font-size-body),1.5vw,var(--font-size-heading-sm))] text-accent mt-4">{ABOUT_ME_DETAILED_PHILOSOPHY_DESCRIPTION}</span>
            </div>
         </motion.div>
         <motion.div initial={contentInitial} whileInView={contentWhileInView} transition={contentTransition} viewport={contentViewport} className="about-me-detailed__philosophy-content flex flex-col">
            <span className="about-me-detailed__philosophy-disclaimer font-hanken-grotesk font-medium max-w-full md:max-w-1/2 self-start text-left text-[clamp(var(--font-size-body-sm),0.875rem,var(--font-size-body-lg))] text-muted my-12.5 px-6 md:px-0">{ABOUT_ME_DETAILED_PHILOSOPHY_DISCLAIMER}</span>
