...
const AboutMeDetailedPrinciplesListCompact = (): React.ReactElement => {
   return (
      <div className="about-me-detailed__philosophy-principles-list about-me-detailed__philosophy-principles-list--compact flex flex-col justify-center px-6 md:px-25">
         <ul className="about-me-detailed__philosophy-principles-list-items font-hanken-grotesk text-[clamp(var(--font-size-body),1.5vw,var(--font-size-body-lg))] text-left text-heading list-none p-0 m-0 flex flex-col gap-3 border-t-2 border-b-2 border-heading py-4">
