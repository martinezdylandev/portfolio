...
import { PROJECT_OVERVIEW_SHOWCASE_IMAGE_CENTER_ALT_TEXT, PROJECT_OVERVIEW_SHOWCASE_IMAGE_LEFT_ALT_TEXT, PROJECT_OVERVIEW_SHOWCASE_IMAGE_RIGHT_ALT_TEXT, PROJECT_OVERVIEW_SHOWCASE_IMAGES_ARIA_LABEL, ProjectOverviewShowcaseProps } from "../../data/projectOverviewShowcaseData";
import { PROJECT_OVERVIEW_SHOWCASE_FLOATING_IMAGES, PROJECTS_WITHOUT_FLOATERS } from "./data/projectOverviewShowcaseImagesData";
...
const ProjectOverviewShowcaseImages = ({ project }: ProjectOverviewShowcaseProps): React.ReactElement => {
   ...
   const basePath = `/projects/${idPadded}/overview`;
   const shouldRenderFloaters = !PROJECTS_WITHOUT_FLOATERS.includes(project.project_id);
   ...
   return (
      <div className="project__overview-showcase-images relative flex justify-center items-center w-full" aria-label={PROJECT_OVERVIEW_SHOWCASE_IMAGES_ARIA_LABEL}>
         {shouldRenderFloaters &&
            PROJECT_OVERVIEW_SHOWCASE_FLOATING_IMAGES.map((floater) => {
               const src = `${basePath}/main-${floater.key}.webp`;
         ...
         <img className="project__overview-showcase-image project__overview-showcase-image--center self-center w-full aspect-video object-cover relative shadow-lg" src={`${basePath}/main-center.webp`} alt={PROJECT_OVERVIEW_SHOWCASE_IMAGE_CENTER_ALT_TEXT} />
      </div>
   );
};
