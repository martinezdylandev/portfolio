         ...
         <Link key={project.project_id} to={`/projects/${project.project_name}`} className="project__related-container-projects-project-link">
            <div className="project__related-container-projects-project-content flex flex-col relative h-fit overflow-hidden">
               <div className="project__related-container-projects-project-upper-part">
                  <img className="project__related-container-projects-project-image size-[272px]" src={projectSecondaryLogo} alt={PROJECT_RELATED_CONTAINER_PROJECTS_IMAGE_ALT_TEXT} />
               </div>
               <motion.div className="project__related-container-projects-project-lower-part flex flex-col w-full overflow-hidden p-3 bg-page" data-testid="related-project-lower-part">
                  <motion.span className="project__related-container-projects-project-second-part text-muted font-medium text-xl" data-testid="project-second-part-name">
