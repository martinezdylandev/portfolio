...
export interface UseProjectRelatedContainerContentAnimationsReturn {
...
export const useProjectRelatedContainerContentAnimations = (): UseProjectRelatedContainerContentAnimationsReturn => {
