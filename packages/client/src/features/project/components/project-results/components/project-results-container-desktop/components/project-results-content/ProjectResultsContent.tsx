   ...
   return (
      <div ref={containerRef} className="project__results-content flex flex-col" aria-label={PROJECT_RESULTS_CONTENT_ARIA_LABEL}>
         <div className="project__results-content-header flex flex-col gap-3 mb-25 text-center" data-testid="results-content-header">
            ...
            <motion.h2 className="project__results-content-header-final font-hanken-grotesk text-display-lg font-bold leading-none text-heading">{PROJECT_RESULTS_CONTENT_SPAN}</motion.h2>
         </div>
         <motion.div initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="project__results-content-body flex flex-col gap-25">
            <div className="project__results-content-body-paragraphs grid gap-6">
               <p className="project__results-content-paragraph text-body-lg h-fit text-justify font-hanken-grotesk font-normal col-start-1 row-start-1 text-body" data-testid="results-content-paragraph">
                  {project.project_final_results_description_part_01}
               </p>
               <p className="project__results-content-paragraph text-body-lg h-fit text-justify font-hanken-grotesk font-normal col-start-2 row-start-2 text-body" data-testid="results-content-paragraph">
            ...
            <div className={`project__results-content-stats grid ${project.project_final_results_stat_03 ? "grid-cols-3" : "grid-cols-2"}`} data-testid="results-content-container">
               <div className="project__results-content-stat flex flex-col" data-testid="results-content-inner-container">
                  <span className="project__results-content-stat-title mb-6 text-body-lg font-hanken-grotesk font-medium text-muted">{project.project_final_results_stat_01_title}</span>
                  <h3 className="project__results-content-stat-value text-heading-xs font-hanken-grotesk font-bold text-body">{project.project_final_results_stat_01}</h3>
               </div>
               ...
               <div className={`project__results-content-stat flex flex-col ${project.project_final_results_stat_03 ? "text-start" : "text-end"}`} data-testid="results-content-inner-container">
                  <span className="project__results-content-stat-title mb-6 text-body-lg font-hanken-grotesk font-medium text-muted">{project.project_final_results_stat_02_title}</span>
                  <h3 className="project__results-content-stat-value text-heading-xs font-hanken-grotesk font-bold text-body">{project.project_final_results_stat_02}</h3>
               </div>

               {project.project_final_results_stat_03 && (
                  <div className="project__results-content-stat flex flex-col" data-testid="results-content-inner-container">
                     <span className="project__results-content-stat-title mb-6 text-body-lg font-hanken-grotesk font-medium text-muted">{project.project_final_results_stat_03_title}</span>
                     <h3 className="project__results-content-stat-value text-heading-xs font-hanken-grotesk font-bold text-body">{project.project_final_results_stat_03}</h3>
                  </div>
               )}
            </div>
         </motion.div>
