   ...
   return (
      <div ref={containerRef} className="project__results-content flex flex-col" aria-label={PROJECT_RESULTS_CONTENT_ARIA_LABEL}>
         <div className="project__results-content-header flex flex-col gap-3 mb-6 text-center" data-testid="results-content-header">
            ...
            <motion.span className="project__results-content-header-final font-hanken-grotesk text-4xl font-bold leading-none text-heading">{PROJECT_RESULTS_CONTENT_SPAN}</motion.span>
         </div>
         <motion.div initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="project__results-content-body grid gap-12">
            ...
            <div className="project__results-content-stat col-start-2 col-end-4 row-start-2 flex flex-col" data-testid="results-content-inner-container">
               <span className="project__results-content-stat-title text-md font-hanken-grotesk font-medium text-muted">{project.project_final_results_stat_01_title}</span>
               <span className="project__results-content-stat-value text-xl font-hanken-grotesk font-bold text-body">{project.project_final_results_stat_01}</span>
            </div>
            ...
            <div className={`project__results-content-stat flex flex-col text-left col-start-1 col-end-3 row-start-4 ${project.project_final_results_stat_03 ? "text-start" : "text-end"}`} data-testid="results-content-inner-container">
               <span className="project__results-content-stat-title text-md font-hanken-grotesk font-medium text-muted">{project.project_final_results_stat_02_title}</span>
               <span className="project__results-content-stat-value text-xl font-hanken-grotesk font-bold text-body">{project.project_final_results_stat_02}</span>
            </div>
