...
const PROJECTS_LIST_SCROLLING_TEXT_CLASS: string =
   "projects-list__scrolling-text-item font-hanken-grotesk text-[clamp(var(--font-size-display),12vw,var(--font-size-display-xl))] text-heading font-bold leading-none m-0 whitespace-nowrap";

export { PROJECTS_LIST_CONTAINER_ARIA_LABEL_TEXT, PROJECTS_LIST_ERROR_ARIA_LABEL, PROJECTS_LIST_ERROR_TEXT, PROJECTS_LIST_LOADING_ARIA_LABEL, PROJECTS_LIST_LOADING_TEXT, PROJECTS_LIST_NO_DATA_TEXT, PROJECTS_LIST_SCROLLING_TEXT_CLASS, PROJECTS_LIST_SCROLLING_TEXT_PROJECTS, PROJECTS_LIST_SCROLLING_TEXT_PROJEKTER, PROJECTS_LIST_SCROLLING_TEXT_PROYECTOS, PROJECTS_LIST_UL_ARIA_LABEL, PROJECTS_LIST_UL_TEST_ID };
