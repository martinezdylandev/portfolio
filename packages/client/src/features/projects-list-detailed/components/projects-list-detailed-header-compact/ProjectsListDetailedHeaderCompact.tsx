   ...
   return (
      <motion.div className="projects-list-detailed__header projects-list-detailed__header--compact pt-25">
         ...
         <motion.div className="flex flex-col min-w-screen min-h-screen gap-6 px-6">
            ...
            <motion.span initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="projects-list-detailed__header-description text-justify font-hanken-grotesk text-body-md text-body">
            ...
            <motion.div initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="flex flex-col gap-3 py-6">
               <span className="projects-list-detailed__header-description self-center text-justify w-3/4 italic font-hanken-grotesk text-caption text-muted leading-snug">{PROJECTS_LIST_DETAILED_HEADER_SPAN_03}</span>
               <span className="projects-list-detailed__header-description self-center text-left w-3/4 font-hanken-grotesk text-caption text-accent font-semibold leading-snug">{PROJECTS_LIST_DETAILED_HEADER_SPAN_04}</span>
            </motion.div>
            <motion.span initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="projects-list-detailed__header-description text-right font-hanken-grotesk text-[clamp(var(--font-size-heading-sm),6vw,var(--font-size-heading-xl))] text-heading font-bold leading-none">
               {PROJECTS_LIST_DETAILED_HEADER_SPAN_06}
            </motion.span>
            <motion.span initial={initial} whileInView={whileInView} transition={transition} viewport={viewport} className="projects-list-detailed__header-description text-justify font-hanken-grotesk text-body-md text-body">
