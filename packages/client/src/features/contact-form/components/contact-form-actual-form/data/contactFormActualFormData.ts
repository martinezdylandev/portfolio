...
export const CONTACT_FORM_DEFAULT_COMPACT_FORM_H3_TEXT_02: string = "ANYTHING THAT YOU WANT TO TALK ABOUT? DO NOT DOUBT TO CONTACT ME.";
export const CONTACT_FORM_DEFAULT_FORM_NAME_PLACEHOLDER: string = "NAME";
export const CONTACT_FORM_DEFAULT_FORM_PHONE_PLACEHOLDER: string = "PHONE NUMBER";
...
export const CONTACT_FORM_DEFAULT_FORM_MESSAGE_ARIA_LABEL: string = "Contact form message";

// Job offer form data
export const CONTACT_FORM_JOB_FORM_ARIA_LABEL: string = "Job offer form";
export const CONTACT_FORM_JOB_FORM_H3_TEXT: string = "IF YOU FIND MY WORK INTERESTING, \nWE CAN HAVE A TALK ABOUT HOW I CAN HELP YOU.";
export const CONTACT_FORM_JOB_FORM_COMPACT_H3_TEXT: string = "IF YOU FIND MY WORK INTERESTING, WE CAN HAVE A TALK ABOUT HOW I CAN HELP YOU.";
export const CONTACT_FORM_JOB_FORM_NAME_PLACEHOLDER: string = "NAME";
export const CONTACT_FORM_JOB_FORM_PHONE_PLACEHOLDER: string = "PHONE NUMBER";
